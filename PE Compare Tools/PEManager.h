...
public:
	...
	//virtual BOOL ReadRawData(DWORD roffset, PVOID buffer, UINT size) = 0;
	//virtual BOOL WriteRawData(DWORD roffset, PVOID buffer, UINT size) = 0;

	virtual BOOL WriteHeader() = 0;

	//virtual BOOL FindRawOffset(DWORD voffset, PVOID roffset = NULL, PVOID sector = NULL) = 0;
